  ...
  "flex w-full h-[48rem] flex-col py-8  px-8   md:px-16 md:h-screen   2xl:px-48 ",
  {
    variants: {
      layout: {
        ...
        form: "text-left !justify-center !items-center !h-fit lg:!h-fit lg:flex-row  2xl:!h-screen",
      },
      defaultVariants: {
        layout: "default",
      },
      ...
      case "form":
        return (
          ...
          >
            ...
            {/* Image Container */}
            <div className="h-fit w-full lg:w-1/2 flex items-center justify-center">
              <Form />
            </div>
          </div>
        );
